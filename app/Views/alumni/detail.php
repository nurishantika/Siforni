...
<div id="detail-alumni" class="signup-form" style="margin:auto">
    <div class="col-auto">
        <form action="/alumni/homepage">

            <h2 id="head-card">Data Alumni</h2>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col">
                        ...
                        <textarea style="width: 1000px;" placeholder="<?= $alumni['judulskripsi']; ?>" disabled></textarea required="required" disabled>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col">
                    ...
                    <textarea id="area-abstrak" style="width: 1000px; height: 250px;;" placeholder="<?= $alumni['abstrak']; ?>" disabled></textarea required="required" disabled>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col">
                    ...
                    <textarea id="area-pencapaian" style="width: 1000px;" placeholder="<?= $alumni['pencapaian']; ?>" disabled></textarea required="required" disabled>
                </div>
            </div>
        </div>
