                ...
                <div class="card-body bg-light text-dark">
                    ...
                    <form action="/berita/save" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="judul_berita" name="judul_berita" autofocus value="<?= $berita['judul_berita']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="isi_berita">Isi Berita</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="5" id="isi_berita" style="height: 500px;" name="isi_berita" value="<?= $berita['isi_berita']; ?>"></textarea>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <label for="foto_berita" class="control-label col-sm-2">Gambar</label>
                            <div class="col-sm-10 mb-4">
                                <input id="foto_berita" type="file" name="foto_berita" value="<?= $berita['foto_berita']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
