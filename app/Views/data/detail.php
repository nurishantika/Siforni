...
<div id="detail-alumni" class="signup-form">
    <form action="/alumni">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col">
                    <label for="" class="form-label-alumni">Periode Bekerja</label>
        ...
        <h4 id="heading-histori">Pencapaian & Penghargaan</h4>

        <div class="form-group">
            <div class="row mb-2">
                <div class="col">
                    <label for="" class="form-label-alumni">Nama Kompetisi & Kejuaraan</label>
                    <input type="text" class="form-control" name="pencapaian" placeholder="<?= $alumni['pencapaian']; ?>" required="required" disabled>
                </div>
                <div class="col">
                    <label for="" class="form-label-alumni">Tahun Kompetisi & Kejuaraan</label>
                    <input type="text" class="form-control" name="thpencapaian" placeholder="<?= $alumni['thpencapaian']; ?>" required="required" disabled>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                <div class="col">
                    <label for="" class="form-label-alumni">Deskripsi Pencapaian</label>
                    <textarea id="area-pencapaian" placeholder="<?= $alumni['despencapaian']; ?>" disabled></textarea required="required" disabled>
                </div>
            </div>
        </div>
