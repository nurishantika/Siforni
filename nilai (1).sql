...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2021 at 04:48 AM
...
(2, 1, 'A', 'B', 'C', 'A-', 'B+', 'C+', 'A', 'B-', 'C-', 'B+', 'B', 'A-', 'A', 'B+', 'B', 'B+', 'A-', 'B+', 'B+', 'B+', 'B-', 'B-', 'B-', 'B-', 'B', 'B-', 'B', 'B', 'B+', 'A-', 'A', 'B-', 'B', 'C', 'B', 'B-', 'B', 'A-', 'C', 'B+', 'B+', 'C+', 'B-', 'C', 'C-', 'B', 'C+', 'B', 'C', 'B+', 'B', 'B', 'B', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'A', 'B+', 'A-', 'A-'),
(3, 15, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(4, 16, '', '', '', '', 'A-', 'B', 'C+', '', '', '', 'B+', 'A-', 'A-', '', 'A-', 'A', '', 'B-', 'A-', 'B+', '', '', 'C+', '', 'B', '', '', 'B-', 'B', '', 'A-', 'B-', 'B-', 'B-', '', 'B+', 'B+', 'A', 'A', '', '', '', 'A-', 'B', '', 'B+', '', '', '', 'A-', '', '', 'B+', 'A-', 'A-', 'A', 'B', 'B-', 'B', 'B+', 'C+', 'B-', 'A-', 'A-', 'A-', '', '', '', 'A-', 'A', 'A', 'A', 'A', '', 'A-');
